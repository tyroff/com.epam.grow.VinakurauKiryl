...
import practice2.task2.transport.WheeledTransportFuelConsumptionComparator;

import java.util.*;
import java.util.concurrent.atomic.AtomicInteger;

/**
 * Implements other specific methods of class {@link StorageInventoryNumbers}
 *
...
public final class StorageInventoryNumbersUtil {
    ...
    /**
     * Sorts the {@link WheeledTransport} object by the {@code fuelConsumption} parameter
    ...
    /**
     * Finds objects {@link WheeledTransport} corresponding to the specified range
